#!/usr/bin/env python3
"""
GATE 1: Relevancy Validation for TikTok Videos
Post-extraction validation for TikTok videos
...
class TikTokRelevancyValidator:
    ...
    def validate(self) -> Dict:
        ...
        print(f"\n🔍 GATE 1: RELEVANCY VALIDATION (TIKTOK)")
        ...
        for idx, video in enumerate(sample_videos):
            ...
            self.validations.append({
                "video_id": video.get("post_id", "N/A"),
                "title": video.get("description", "")[:60],
                "score": score
            })
    ...
    def _score_video(self, video: Dict) -> int:
        ...
        full_content = f"{description} {hashtags}"
        ...
        # Relaxed for TikTok which has shorter descriptions
...
def main():
    data_file = "/Volumes/DATA/consulting/garage-organizer-data-collection/raw-data/tiktok_videos_raw.json"

    validator = TikTokRelevancyValidator(data_file)

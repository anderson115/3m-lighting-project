#!/usr/bin/env python3
"""
Scrape Menards using Bright Data API.
"""
import requests
import json
import os
...
if not BRIGHTDATA_API_TOKEN:
    raise ValueError("BRIGHTDATA_API_TOKEN environment variable not set. Run with: op run -- python scrape_menards_brightdata.py")

print("="*70)
print("SCRAPING MENARDS WITH BRIGHT DATA")
print("="*70)
print()
...
if all_products:
    output_file = Path("data/retailers/menards_products_brightdata.json")
